...
public class KingsongData {
    ...
    public float getTopSpeed() { return (float)mTopSpeed; }
    public float getDistance() { return (float)mDistance; }
    public float getTotalDistance() { return (float)mTotalDistance; }
    public long getTime() { return mCurrentTime; }
